...
var (
	...
	ErrAccountNotFound                        = NewNormalError(NormalSubcategoryAccount, 1, http.StatusNotFound, "account not found")
	...
	ErrSourceAccountNotFound                  = NewNormalError(NormalSubcategoryAccount, 11, http.StatusNotFound, "source account not found")
	ErrDestinationAccountNotFound             = NewNormalError(NormalSubcategoryAccount, 12, http.StatusNotFound, "destination account not found")
	ErrAccountInUseCannotBeDeleted            = NewNormalError(NormalSubcategoryAccount, 13, http.StatusConflict, "account is in use and cannot be deleted")
	...
	ErrSubAccountNotFound                     = NewNormalError(NormalSubcategoryAccount, 18, http.StatusNotFound, "sub-account not found")
	ErrSubAccountInUseCannotBeDeleted         = NewNormalError(NormalSubcategoryAccount, 19, http.StatusConflict, "sub-account is in use and cannot be deleted")
