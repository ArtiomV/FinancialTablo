...
var (
	ErrUserCustomExchangeRateNotFound             = NewNormalError(NormalSubcategoryUserCustomExchangeRate, 0, http.StatusNotFound, "user custom exchange rate data not found")
