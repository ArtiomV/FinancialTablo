...
var (
	...
	ErrUserNotFound                                        = NewNormalError(NormalSubcategoryUser, 10, http.StatusNotFound, "user not found")
	ErrUserPasswordWrong                                   = NewNormalError(NormalSubcategoryUser, 11, http.StatusBadRequest, "password is wrong")
	ErrUsernameAlreadyExists                               = NewNormalError(NormalSubcategoryUser, 12, http.StatusConflict, "username already exists")
	ErrUserEmailAlreadyExists                              = NewNormalError(NormalSubcategoryUser, 13, http.StatusConflict, "email already exists")
