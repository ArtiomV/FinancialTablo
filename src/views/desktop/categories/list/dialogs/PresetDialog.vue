        ...
        <v-card class="pa-sm-1 pa-md-2">
            ...
            <v-card-text class="preset-transaction-categories flex-grow-1 overflow-y-auto">
                <template :key="categoryType" v-for="(categories, categoryType) in allPresetCategories">
                    ...
                    <v-list class="border rounded mb-2" density="comfortable" :disabled="submitting">
...
import { localizedPresetCategoriesToTransactionCategoryCreateRequests } from '@/lib/category.ts';
...
function save(): void {
    ...
    const submitCategories = localizedPresetCategoriesToTransactionCategoryCreateRequests(presetCategoriesArray);
