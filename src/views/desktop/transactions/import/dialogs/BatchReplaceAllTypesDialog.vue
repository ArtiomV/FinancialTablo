                                ...
                                <tr style="background-color: rgb(var(--v-theme-surface))">
                                    ...
                                    <td>
                                        <two-column-select density="compact" variant="underlined"
                                                           ...
                                                           :custom-selection-primary-text="getCategoryNameById(newRule.targetId, allCategories[CategoryType.Expense])"
                                        ...
                                        <two-column-select density="compact" variant="underlined"
                                                           ...
                                                           :enable-filter="true" :filter-placeholder="tt('Find category')" :filter-no-items-text="tt('No available category')"
                                                           :show-selection-primary-text="true"
                                                           :custom-selection-primary-text="getCategoryNameById(newRule.targetId, allCategories[CategoryType.Income])"
                                        ...
                                        <two-column-select density="compact" variant="underlined"
                                                           ...
                                                           :enable-filter="true" :filter-placeholder="tt('Find category')" :filter-no-items-text="tt('No available category')"
                                                           :show-selection-primary-text="true"
                                                           :custom-selection-primary-text="getCategoryNameById(newRule.targetId, allCategories[CategoryType.Transfer])"
...
function getRuleTargetValueDisplayName(rule: ImportTransactionReplaceRule): string {
    switch (rule.dataType) {
        case 'expenseCategory':
            return getCategoryNameById(rule.targetId, allCategories.value[CategoryType.Expense]) || '';
        case 'incomeCategory':
            return getCategoryNameById(rule.targetId, allCategories.value[CategoryType.Income]) || '';
        case 'transferCategory':
            return getCategoryNameById(rule.targetId, allCategories.value[CategoryType.Transfer]) || '';
        case 'account':
