                ...
                <v-row>
                    ...
                    <v-col cols="12">
                        <two-column-select primary-key-field="id" primary-value-field="id" primary-title-field="name"
                                           ...
                                           :custom-selection-primary-text="getCategoryNameById(targetItem, allCategories[CategoryType.Expense])"
                        ...
                        <two-column-select primary-key-field="id" primary-value-field="id" primary-title-field="name"
                                           ...
                                           :enable-filter="true" :filter-placeholder="tt('Find category')" :filter-no-items-text="tt('No available category')"
                                           :show-selection-primary-text="true"
                                           :custom-selection-primary-text="getCategoryNameById(targetItem, allCategories[CategoryType.Income])"
                                           :label="tt('Target Category')"
                                           :placeholder="tt('Target Category')"
                        ...
                        <two-column-select primary-key-field="id" primary-value-field="id" primary-title-field="name"
                                           ...
                                           :enable-filter="true" :filter-placeholder="tt('Find category')" :filter-no-items-text="tt('No available category')"
                                           :show-selection-primary-text="true"
                                           :custom-selection-primary-text="getCategoryNameById(targetItem, allCategories[CategoryType.Transfer])"
                                           :label="tt('Target Category')"
                                           :placeholder="tt('Target Category')"
