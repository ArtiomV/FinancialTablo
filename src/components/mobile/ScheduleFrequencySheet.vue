            ...
            <div class="grid grid-cols-2 grid-gap">
                ...
                <div>
                    <div class="schedule-frequency-value-container">
                        ...
                        <f7-list dividers class="schedule-frequency-value-list no-margin-vertical"
                                 v-if="currentFrequencyType === ScheduledTemplateFrequencyType.Monthly.type || currentFrequencyType === ScheduledTemplateFrequencyType.Bimonthly.type || currentFrequencyType === ScheduledTemplateFrequencyType.Quarterly.type || currentFrequencyType === ScheduledTemplateFrequencyType.Semiannually.type || currentFrequencyType === ScheduledTemplateFrequencyType.Annually.type">
                            <f7-list-item checkbox
