...
export class Transaction implements TransactionInfoResponse {
    ...
    public toCreateRequest(clientSessionId: string, repeatOptions?: { repeatable: boolean, repeatFrequencyType: number, repeatFrequency: string }): TransactionCreateRequest {
    ...
    public static of(transactionResponse: TransactionInfoResponse): Transaction {
        const transaction: Transaction = new Transaction(
            ...
            transactionResponse.counterpartyId || '0',
