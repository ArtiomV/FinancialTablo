...
import CounterpartyListPage from '@/views/mobile/counterparties/ListPage.vue';
import CounterpartyEditPage from '@/views/mobile/counterparties/EditPage.vue';
...
const routes: Router.RouteParameters[] = [
    ...
    },
    {
        ...
        async: asyncResolve(CounterpartyListPage),
        beforeEnter: [checkLogin]
    },
    {
        path: '/counterparty/add',
        async: asyncResolve(CounterpartyEditPage),
        beforeEnter: [checkLogin]
    },
    {
