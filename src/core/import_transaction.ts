...
export class ImportTransactionColumnType implements TypeAndName {
    ...
    public static readonly TransactionTime = new ImportTransactionColumnType(1, 'import.Transaction Time');
    public static readonly TransactionTimezone = new ImportTransactionColumnType(2, 'import.Transaction Timezone');
    public static readonly TransactionType = new ImportTransactionColumnType(3, 'import.Transaction Type');
    public static readonly Category = new ImportTransactionColumnType(4, 'import.Category');
    public static readonly SubCategory = new ImportTransactionColumnType(5, 'import.Sub Category');
    public static readonly AccountName = new ImportTransactionColumnType(6, 'import.Account Name');
    public static readonly AccountCurrency = new ImportTransactionColumnType(7, 'import.Currency');
    public static readonly Amount = new ImportTransactionColumnType(8, 'import.Amount');
    public static readonly RelatedAccountName = new ImportTransactionColumnType(9, 'import.Related Account Name');
    public static readonly RelatedAccountCurrency = new ImportTransactionColumnType(10, 'import.Related Account Currency');
    public static readonly RelatedAmount = new ImportTransactionColumnType(11, 'import.Related Amount');
    public static readonly GeographicLocation = new ImportTransactionColumnType(12, 'import.Geographic Location');
    public static readonly Tags = new ImportTransactionColumnType(13, 'import.Tags');
    public static readonly Description = new ImportTransactionColumnType(14, 'import.Description');
    public static readonly TagGroup = new ImportTransactionColumnType(15, 'import.Tag Group');
    public static readonly Counterparty = new ImportTransactionColumnType(101, 'import.Counterparty');
