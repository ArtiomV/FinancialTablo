...
import type {
    ...
    CounterpartyModifyRequest,
    CounterpartyHideRequest,
    CounterpartyMoveRequest,
...
export default {
    ...
    confirmPlannedTransaction: (req: { id: string }): ApiResponsePromise<TransactionInfoResponse> => {
        return axios.post<ApiResponse<TransactionInfoResponse>>('v1/transactions/confirm.json', req);
    },
    modifyAllFuturePlannedTransactions: (req: { id: string, sourceAmount?: number, categoryId?: string, sourceAccountId?: string, destinationAccountId?: string, destinationAmount?: number, hideAmount?: boolean, counterpartyId?: string, comment?: string }): ApiResponsePromise<{ affectedCount: number }> => {
        return axios.post<ApiResponse<{ affectedCount: number }>>('v1/transactions/modify_all_future.json', req);
    },
    ...
    getAllCounterparties: (): ApiResponsePromise<CounterpartyInfoResponse[]> => {
        return axios.get<ApiResponse<CounterpartyInfoResponse[]>>('v1/transaction/counterparties/list.json');
    },
    getCounterparty: ({ id }: { id: string }): ApiResponsePromise<CounterpartyInfoResponse> => {
        return axios.get<ApiResponse<CounterpartyInfoResponse>>('v1/transaction/counterparties/get.json?id=' + id);
    },
    addCounterparty: (req: CounterpartyCreateRequest): ApiResponsePromise<CounterpartyInfoResponse> => {
        return axios.post<ApiResponse<CounterpartyInfoResponse>>('v1/transaction/counterparties/add.json', req);
    },
    modifyCounterparty: (req: CounterpartyModifyRequest): ApiResponsePromise<CounterpartyInfoResponse> => {
        return axios.post<ApiResponse<CounterpartyInfoResponse>>('v1/transaction/counterparties/modify.json', req);
    },
    hideCounterparty: (req: CounterpartyHideRequest): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>('v1/transaction/counterparties/hide.json', req);
    },
    moveCounterparty: (req: CounterpartyMoveRequest): ApiResponsePromise<boolean> => {
        return axios.post<ApiResponse<boolean>>('v1/transaction/counterparties/move.json', req);
    },
