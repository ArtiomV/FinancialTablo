        ...
        themes: {
            light: {
                ...
                colors: {
                    ...
                    'on-secondary': '#ffffff',
                    'success': '#2E8B57',
                    'success-darken-1': '#267349',
                    'on-success': '#ffffff',
                    'info': '#7B2D8E',
                    'info-darken-1': '#652576',
                    'on-info': '#ffffff',
                    'warning': '#E8B830',
                    'warning-darken-1': '#C99B20',
                    'on-warning': '#ffffff',
                    'error': '#C41E3A',
                    'error-darken-1': '#A3162F',
                    'on-error': '#ffffff',
                    'teal': '#2E8B57',
                    'background': '#FFFDF5',
                    'on-background': '#3B2F2F',
                    'surface': '#FFFFF0',
                    'on-surface': '#3B2F2F',
                    ...
                    'skin-bordered-background': '#FFFFF0',
                    'skin-bordered-surface': '#FFFFF0',
                    'expansion-panel-text-custom-bg': '#fafafa'
                },
                variables: {
                    'code-color': '#ff8000',
                    'overlay-scrim-background': '#3B2F2F',
                    ...
                    'border-color': '#3B2F2F',
                    'border-opacity': 0.12,
                    'table-header-color': '#FDFCF5',
                    'high-emphasis-opacity': 0.9,
                    'medium-emphasis-opacity': 0.7,

                    // 👉 shadows
                    'shadow-key-umbra-color': '#3B2F2F',
            ...
            dark: {
                ...
                colors: {
                    'primary': '#E8B830',
                    'primary-darken-1': '#D4A017',
                    'on-primary': '#ffffff',
                    'secondary': '#9d9b99',
                    'secondary-darken-1': '#3e3d3c',
                    'on-secondary': '#fff',
                    'success': '#3CB371',
                    'success-darken-1': '#2E8B57',
                    'on-success': '#ffffff',
                    'info': '#9B59B6',
                    'info-darken-1': '#7B2D8E',
                    'on-info': '#ffffff',
                    'warning': '#F0C850',
                    'warning-darken-1': '#E8B830',
                    'on-warning': '#ffffff',
                    'error': '#E74C3C',
                    'error-darken-1': '#C41E3A',
                    'on-error': '#ffffff',
                    'teal': '#3CB371',
                    'background': '#0D0B08',
                    ...
                    'grey-800': '#d8d8d8',
                    'grey-900': '#eaeaea',
                    'perfect-scrollbar-thumb': '#5A4A2D',
                    'skin-bordered-background': '#2A2010',
                    'skin-bordered-surface': '#2A2010',
                    'expansion-panel-text-custom-bg': '#2A2010'
                },
                variables: {
                    'code-color': '#ff8000',
