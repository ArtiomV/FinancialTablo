        ...
        themes: {
            light: {
                ...
                colors: {
                    ...
                    'on-primary': '#ffffff',
                    'secondary': '#8692A6',
                    'secondary-darken-1': '#5A6577',
                    'on-secondary': '#ffffff',
                    'success': '#2E8B57',
                    'success-darken-1': '#267349',
                    'on-success': '#ffffff',
                    'info': '#5B8DB8',
                    'info-darken-1': '#4A7A9E',
                    'on-info': '#ffffff',
                    'warning': '#E5A100',
                    'warning-darken-1': '#CC8F00',
                    'on-warning': '#ffffff',
                    'error': '#D04255',
                    'error-darken-1': '#B8354A',
                    'on-error': '#ffffff',
                    'teal': '#2E8B57',
                    'background': '#FFFFFF',
                    ...
                    'on-notification-background': '#1F2937',
                    'grey': '#8692A6',
                    'grey-50': '#F9FAFB',
                    'grey-100': '#F3F4F6',
                    'grey-200': '#E5E7EB',
            ...
            dark: {
                ...
                colors: {
                    ...
                    'on-success': '#ffffff',
                    'info': '#7CB3D8',
                    'info-darken-1': '#5B8DB8',
                    'on-info': '#ffffff',
                    'warning': '#F0B429',
                    'warning-darken-1': '#E5A100',
                    'on-warning': '#ffffff',
                    'error': '#E85D75',
                    'error-darken-1': '#D04255',
                    'on-error': '#ffffff',
                    'teal': '#3CB371',
                    'background': '#111827',
                    ...
                    'on-notification-background': '#E5E7EB',
                    'grey': '#4B5563',
                    'grey-50': '#1F2937',
                    'grey-100': '#374151',
                    'grey-200': '#4B5563',
